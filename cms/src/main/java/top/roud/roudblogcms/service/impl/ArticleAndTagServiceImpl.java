...
public class ArticleAndTagServiceImpl implements ArticleAndTagService {
    ...
    public Page<ArticleWithValidateCode> findPageWithValidatecode(Integer pageNum, Integer pageSize, String search) {
        ...
        List<ArticleWithValidateCode> newRecords = new ArrayList<>();
    ...
    public Page<Article> findPageByTagWithoutBody(Integer pageNum, Integer pageSize, String search) {
        ...
        List<Article> recordsNew = new ArrayList<>();
        ...
        result.setTotal(total);
        result.setCurrent(pageNum);
        result.setRecords(sortArticleHandler(recordsNew));
        return result;
    }
    ...
    private List<Article> sortArticleHandler(List<Article> articleList){
    ...
    private void sortValHandler(Article article){
        if(0 == article.getSort()){
            article.setSort(2);
        }
    }
